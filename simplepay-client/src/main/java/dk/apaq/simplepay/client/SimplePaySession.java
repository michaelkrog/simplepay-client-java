 ...
 * <br><br>
 * An application can have as many sessions it likes with each having their own key.
 * In most systems a single session will suffice, but larger multiuser systems might need
